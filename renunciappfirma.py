...
#DOCUMENTO PROPIAMENTE TAL
    ...
    suma=" Renuncia patrocinio y poder"
    ...
    parrafo2.add_run("""     Que por este acto, pongo en conocimiento de S.S. que renuncio al patrocinio y poder conferido por la solicitante
en autos, atendido a que finalizó la gestión judicial para el cual fue conferido. De esta forma, se ha dado cumplimiento a lo dispuesto por
el artículo 10 inciso segundo del Código de Procedimiento Civil, que dispone: """)
    parrafo2.add_run('''“si la causa de la expiración del mandato es la renuncia del procurador, estará éste obligado a ponerla en conocimiento
de su mandante, junto con el estado del juicio, y se entenderá vigente el poder hasta que haya transcurrido el término de emplazamiento desde
la notificación de la renuncia al mandante”. ''').italic=True
